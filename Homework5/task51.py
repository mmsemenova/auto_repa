...
def letter_stat(our_str):
    ...
    # Генерируем словарь, где ключами будут буквы из строки,
    # а значениями (х) будет количество (сколько раз встречалась данная буква в строке)
    letters_dict = {x: our_str.count(x) for x in list(our_str)}
